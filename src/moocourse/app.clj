(ns moocourse.app
  (:require [com.biffweb :as biff :refer [q]]
            [moocourse.middleware :as mid]
            [moocourse.ui :as ui]
            [moocourse.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [moocourse/chat-clients]} tx]
...
(defn ws-handler [{:keys [moocourse/chat-clients] :as ctx}]
  {:status 101
